...
// render teture at given point along with rotation angle, based on which point to rotate, and flipping
...
// render clipped texture at the given point along with rotation angle, based on which point to rotate, and flipping
