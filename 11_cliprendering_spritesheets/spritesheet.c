...
bool init() {
  ...
  // create window
  gWindow = SDL_CreateWindow("11 - Clip Rendering and Sprite Sheets", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
  if (gWindow == NULL) {
